...
?>	
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input id="potenciaInversor" name="potenciaInversor" class="form-control entero" required="required" type="int" value="<?php echo $inversor->getPotenciaCA();?>"/>
				</div>
			...
			<div class="form-group">
					<input id="corrienteEntrada" name="corrienteEntrada" class="hide" value ="0"/>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
...
?>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input id="nominal" name="nominal" class="form-control entero" type="int" value="<?php echo $panel->getNominal();?>"/>
					</div>
					<label class="col-sm-3 control-label" for="voltajeCorrienteAlterna">Voltaje Circuito Abierto(V)</label>
					<div class="col-sm-3">
						<input id="voltajeCorrienteAlterna" name="voltajeCorrienteAlterna" class="form-control entero" type="int" value="<?php echo $panel->getVCA();?>"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input id="altoPanel" name="altoPanel" class="form-control decimal" type="float" value="<?php echo $panel->getAlto();?>"/>
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input id="altoAncho" name="altoAncho" class="form-control decimal" type="float" value="<?php echo $panel->getAncho();?>"/>
							<span class="input-group-addon">Mts.</span>
						</div>
					</div>
				</div>
